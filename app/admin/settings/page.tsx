  ...
  return (
    <ProtectedRoute allowedRoles={["admin"]}>
      <div className={`min-h-screen flex flex-col items-center justify-center ${bg}`}>
        ...
        >
          <h1 className="text-2xl font-bold mb-4 text-red-600">Manager Settings</h1>
          ...
          <input
            ...
            className="w-full p-2 border rounded-lg mb-4 bg-transparent border-gray-300 dark:border-gray-600 focus:ring focus:ring-red-400"
          />
          <button
            onClick={handleSave}
            disabled={saving}
            className="bg-red-600 text-white px-5 py-2 rounded-lg hover:bg-red-700 transition disabled:opacity-70"
          >
            {saving ? "Saving..." : "Save"}
          </button>
          {status && (
